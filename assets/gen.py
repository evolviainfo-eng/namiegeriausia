...
<header class="nav">
  <div class="wrap">
    ...
    <details class="mnav">
      <summary aria-label="Meniu"><span class="bg"><i></i><i></i><i></i></span></summary>
      <div class="mpanel">
        <nav aria-label="Meniu telefone">
          <a href="/#projektai">Projektai</a>
          <a href="/paslaugos/">Paslaugos</a>
          <a href="/#kontaktai">Kontaktai</a>
        </nav>
        <div class="mfoot">
          <a class="ulink" href="tel:+37068020901">+370 680 20901</a>
          <a class="ulink" href="mailto:brigita@namiegeriausia.lt">brigita@namiegeriausia.lt</a>
        </div>
      </div>
    </details>
  </div>
